...
Hi, welcome to my personal website and portfolio!

I recently recieved my master in environmental science and management from   UC Santa Barbara with a specialization in Energy & Climate. My master's project, which involved assessing the feasibility of solar projects for multifamily housing in the United States, demonstrated my proficiency in data analysis and visualization. By developing an interactive model in R, she identified optimal regions to invest in multifamily housing and accelerate solar adoption, given stakeholder preferences.

With my interdisciplinary understanding of environmental issues and multi-sector perspective to identify solutions, I am actively seeking positions that leverage my expertise in data analysis and visualization to develop innovative climate solutions. My interests include renewable energy development, land-use impacts, corporate sustainability, and regenerative agriculture. In my free time, I enjoy cooking, reading, and spending time outdoors. 
...
[Model to Identify Favorable Areas to invest in Multifamily Housing convert into Net Zero Energy Properties ](https://gbianch.shinyapps.io/solar_fam_model/)
...
-   [Data Science/Computing:]{.underline} Data Analysis and Statistics; Advanced Data Analysis; Computing in Environmental Science; Geographical Information Systems (QGIS); Environemntal Modeling; Statistical Methods in Biology (in R), Programming with MM Objects (Computer Science in Python)

-   [Energy & Climate]{.underline}**:** Energy Demand Analysis; Energy, Technology, & the Environment; Electricity Markets; Pollution Precention

-   [Environmental Engineering]{.underline}**:** Environmental Sustainability; Industrial Ecology and LCA; Intro to Civil Engineering

-   [Conservation]{.underline}**:** Fate & Transport of Pollutants, Environmental & Conservation Biology, Soil Science, Advanced Ecology, Disease Ecology\
